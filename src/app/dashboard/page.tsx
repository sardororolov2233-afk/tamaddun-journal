            ...
            {user.role === 'admin' && (
              <>
                ...
                <button 
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><i className="ti ti-files" style={{ fontSize: '16px' }}></i> {lang === 'UZ' ? 'Kutayotganlar' : 'Ожидающие'}</span>
                ...
                <button 
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><i className="ti ti-checklist" style={{ fontSize: '16px' }}></i> {lang === 'UZ' ? 'Chop etilganlar' : 'Опубликованные'}</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem', marginBottom: '2.5rem' }}>
              {user.role === 'author' && (
                <>
                  ...
                  <div style={{ background: 'var(--cream)', border: '1px solid var(--border)', borderRadius: '8px', padding: '1.5rem' }}>
                    <div style={{ color: 'var(--muted)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '8px' }}>Chop etilgan</div>
              ...
              {user.role === 'reviewer' && (
                <>
                  <div style={{ background: 'var(--cream)', border: '1px solid var(--border)', borderRadius: '8px', padding: '1.5rem' }}>
                    <div style={{ color: 'var(--muted)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '8px' }}>Yangi vazifalar (Kutayotganlar)</div>
                    <div style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--gold)' }}>{pendingArticles.length}</div>
                  </div>
                  <div style={{ background: 'var(--cream)', border: '1px solid var(--border)', borderRadius: '8px', padding: '1.5rem' }}>
                    <div style={{ color: 'var(--muted)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '8px' }}>Tugallangan taqrizlar</div>
              ...
              {user.role === 'admin' && (
                <>
                  ...
                  <div style={{ background: 'var(--cream)', border: '1px solid var(--border)', borderRadius: '8px', padding: '1.5rem' }}>
                    <div style={{ color: 'var(--muted)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '8px' }}>Rad etilganlar</div>
                    <div style={{ fontSize: '2rem', fontWeight: 700, color: '#e53935' }}>{rejectedArticles.length}</div>
                  </div>
                </>
              )}
            </div>
